 ...
 <div class="col-sm-4 col-sm-push-3 well">
   ...
   {{ csrf_field() }}
    <div class="form-group">
      <input type="text" name="name" required placeholder ="Введите Имя" class="form-control">
    </div>
   
    <div class="form-group">
      <input type="text" name="surname" required placeholder ="Введите Фамилию" class="form-control">
    </div>
    
    <div class="form-group">
      <input type="text" name="father" required placeholder ="Введите отчество" class="form-control">
    </div>
    
    <div class="form-group">
      <input type="text" name="otdel" required placeholder ="Введите отдел" class="form-control">
    </div>
